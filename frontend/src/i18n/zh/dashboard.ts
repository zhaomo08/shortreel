...
export default {
  ...
  'output_language_auto': '跟随源文',
  'output_language_en': 'English',
  'output_language_zh': '中文',
  'output_language_vi': 'Tiếng Việt',
  'output_language_hint': '默认按你上传的源文语言产出剧本、口播、字幕与画面提示词；锁定某个语言可以用中文梗概做英文片。',
  ...
  'review_convert_action': '转为正式脚本',
  'review_convert_title': '转为正式脚本',
  'review_convert_desc':
    '「直接转换」只把已确认的内容逐条搬进正式脚本，不调用模型，分镜图与视频提示词留空待生成；随后仍需让 Agent 或手动补齐。推荐让 Agent 生成：内容与提示词一次完成。',
  'review_convert_loading': '正在比对脚本规划与正式脚本…',
  ...
  'tool_name_convert_script_plan': '转为正式脚本',
  ...
  'test_fail': '无法连通',
  'messages_url': '调用地址',
  'messages_url_preview_hint': 'Claude Agent 固定调用：',
  'base_url_unsupported_components': '地址不能带查询参数、锚点或用户名密码，请填写形如 https://host/path 的地址',
