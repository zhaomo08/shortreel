...
export default {
  ...
  'review_convert_action': 'Chuyển thành kịch bản chính thức',
  'review_convert_title': 'Chuyển thành kịch bản chính thức',
  'review_convert_desc':
    '「Chuyển trực tiếp」 chỉ sao chép nội dung đã xác nhận vào kịch bản chính thức theo từng cảnh, không gọi mô hình; prompt ảnh phân cảnh và video để trống chờ tạo, sau đó vẫn cần Agent hoặc chỉnh tay để bổ sung. Khuyến nghị để Agent tạo: nội dung và prompt hoàn tất trong một lượt.',
  'review_convert_loading': 'Đang so sánh kế hoạch kịch bản với kịch bản chính thức…',
  ...
  'tool_name_convert_script_plan': 'Chuyển thành kịch bản chính thức',
  ...
  'messages_url': 'Địa chỉ gọi',
  'messages_url_preview_hint': 'Claude Agent luôn gọi:',
  'base_url_unsupported_components': 'Địa chỉ không được chứa tham số truy vấn, fragment hay tên người dùng/mật khẩu. Hãy dùng dạng https://host/path.',
