...
export default {
  ...
  'review_convert_action': 'Convert to final script',
  'review_convert_title': 'Convert to final script',
  'review_convert_desc':
    '"Convert directly" copies the confirmed content into the final script entry by entry without calling a model; storyboard and video prompts stay empty, pending. You will still need the Agent or manual edits to fill them in. Letting the Agent generate is recommended: content and prompts land in one pass.',
  'review_convert_loading': 'Comparing the script plan with the final script…',
  ...
  'tool_name_convert_script_plan': 'Convert to final script',
  ...
  'messages_url': 'Request URL',
  'messages_url_preview_hint': 'Claude Agent always calls:',
  'base_url_unsupported_components': 'The URL cannot carry a query string, fragment or username/password. Use a plain https://host/path address.',
